...
extension APIEndpoint {
	...
	public struct Profiles {
		...
		public func get(parameters: GetParameters? = nil) -> Request<EnterpriseProgram_Swift_SDK.ProfilesResponse> {
		...
		/// Create a Profile
		public func post(_ body: EnterpriseProgram_Swift_SDK.ProfileCreateRequest) -> Request<EnterpriseProgram_Swift_SDK.ProfileResponse> {
