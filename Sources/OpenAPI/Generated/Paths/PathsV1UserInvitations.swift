...
extension APIEndpoint {
	...
	public struct UserInvitations {
		...
		/// List Invited Users
		public func get(parameters: GetParameters? = nil) -> Request<EnterpriseProgram_Swift_SDK.UserInvitationsResponse> {
		...
		/// Invite a User
		public func post(_ body: EnterpriseProgram_Swift_SDK.UserInvitationCreateRequest) -> Request<EnterpriseProgram_Swift_SDK.UserInvitationResponse> {
