...
extension APIEndpoint.PassTypeIDs {
	...
	public struct WithID {
		...
		/// Modify a PassTypeId
		public func patch(_ body: EnterpriseProgram_Swift_SDK.PassTypeIDUpdateRequest) -> Request<EnterpriseProgram_Swift_SDK.PassTypeIDResponse> {
