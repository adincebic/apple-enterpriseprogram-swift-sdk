...
extension APIEndpoint {
	...
	public struct PassTypeIDs {
		...
		/// List Pass Type Ids
		public func get(parameters: GetParameters? = nil) -> Request<EnterpriseProgram_Swift_SDK.PassTypeIDsResponse> {
		...
		/// Create a PassTypeId
		public func post(_ body: EnterpriseProgram_Swift_SDK.PassTypeIDCreateRequest) -> Request<EnterpriseProgram_Swift_SDK.PassTypeIDResponse> {
