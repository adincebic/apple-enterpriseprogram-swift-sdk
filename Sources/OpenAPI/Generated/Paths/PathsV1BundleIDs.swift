...
extension APIEndpoint {
	...
	public struct BundleIDs {
		...
		/// List Bundle Ids
		public func get(parameters: GetParameters? = nil) -> Request<EnterpriseProgram_Swift_SDK.BundleIDsResponse> {
		...
		public func post(_ body: EnterpriseProgram_Swift_SDK.BundleIDCreateRequest) -> Request<EnterpriseProgram_Swift_SDK.BundleIDResponse> {
