...
extension APIEndpoint {
	...
	public struct Devices {
		...
		/// List Devices
		public func get(parameters: GetParameters? = nil) -> Request<EnterpriseProgram_Swift_SDK.DevicesResponse> {
		...
		public func post(_ body: EnterpriseProgram_Swift_SDK.DeviceCreateRequest) -> Request<EnterpriseProgram_Swift_SDK.DeviceResponse> {
