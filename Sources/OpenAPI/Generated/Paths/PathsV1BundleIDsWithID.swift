...
extension APIEndpoint.BundleIDs {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<EnterpriseProgram_Swift_SDK.BundleIDResponse> {
		...
		/// Modify a BundleId
		public func patch(_ body: EnterpriseProgram_Swift_SDK.BundleIDUpdateRequest) -> Request<EnterpriseProgram_Swift_SDK.BundleIDResponse> {
